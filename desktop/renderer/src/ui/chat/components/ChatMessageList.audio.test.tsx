  ...
  it("renders historical generated images from tool result file paths", async () => {
                  ...
                  attachments: [
                    {
                      ...
                      mimeType: "image/png",
                      filePath:
                        "/Users/guilhermevarela/Library/Application Support/openspace-desktop/openclaw/media/tool-image-generation/image-1---8e376867-b20a-494c-8b12-ada5ebb3d5e1.png",
                    },
                  ],
                },
              ],
    ...
    await waitFor(() => {
      ...
      expect(image?.getAttribute("src")).toBe(
        `data:application/octet-stream;base64,${btoa("/Users/guilhermevarela/Library/Application Support/openspace-desktop/openclaw/media/tool-image-generation/image-1---8e376867-b20a-494c-8b12-ada5ebb3d5e1.png")}`
      );
    });
  });
