...
describe("InlineOllamaConfig", () => {
  ...
  it("shows local setup steps by default", () => {
    ...
    expect(screen.getByText("Test the connection and start using it in OpenSpace")).not.toBeNull();
  });
  ...
  it("shows API key input when switching to Cloud mode", () => {
    ...
    expect(screen.getByText("Paste it below and start using it in OpenSpace")).not.toBeNull();
    const passwordInputs = document.querySelectorAll('input[type="password"]');
  ...
  describe("localStorage persistence", () => {
    ...
    it("restores local mode from localStorage on mount", () => {
      ...
      expect(
        screen.getByText("Test the connection and start using it in OpenSpace")
      ).not.toBeNull();
