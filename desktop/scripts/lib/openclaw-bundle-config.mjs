...
export const ESBUILD_EXTERNALS_POLICY = [
  ...
  "qs",
  "rimraf",
  // file-type: intentionally NOT external — esbuild resolves subpath + default export
  // Bottleneck has test/config files with dev-only imports that break bundling
  "bottleneck",
  "bottleneck/*",
  // Chalk uses Node.js imports map (#ansi-styles) which esbuild 0.24 doesn't resolve
  "chalk",
